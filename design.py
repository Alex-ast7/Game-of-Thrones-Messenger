...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.send_button.setIconSize(
            QSize(self.send_button.width() + 30, self.send_button.height()))
        ...
        # установка расположения виджетов в чате
        ...
        self.help_button.setGeometry(
            (QtCore.QRect(SCREEN_WIDTH * 0.77, 14, 80, 20)))
